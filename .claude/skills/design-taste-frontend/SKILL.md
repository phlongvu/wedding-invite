...
description: Apply strong frontend design taste (layout, typography, motion, spacing, color) when redesigning or styling landing pages, portfolios, or one-off pages like this wedding invite site — avoids generic/boilerplate-looking AI UI. Sourced from Leonxlnx/taste-skill (MIT), reviewed for safety before adding.
---
